...
import uk.openlab.inputmethod.logger.data.CompletedTask;
import uk.openlab.inputmethod.logger.data.Config;
import uk.openlab.inputmethod.logger.data.Prompt;
import uk.openlab.inputmethod.logger.data.TimeFrame;
                        ...
                        if(user != null){
                            FirebaseInstanceId.getInstance().getInstanceId()
                                    .addOnCompleteListener(task1 -> {
                                        ...
                                        write("name", user.getDisplayName(), "/user-list/"+user.getUid()+"/");
