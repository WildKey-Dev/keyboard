...
package uk.openlab.inputmethod.latin.inputlogic;
...
import uk.openlab.inputmethod.compat.SuggestionSpanUtils;
...
import uk.openlab.inputmethod.latin.Dictionary;
import uk.openlab.inputmethod.latin.DictionaryFacilitator;
import uk.openlab.inputmethod.latin.LastComposedWord;
import uk.openlab.inputmethod.latin.LatinIME;
import uk.openlab.inputmethod.latin.NgramContext;
import uk.openlab.inputmethod.latin.RichInputConnection;
import uk.openlab.inputmethod.latin.Suggest;
import uk.openlab.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import uk.openlab.inputmethod.latin.SuggestedWords;
import uk.openlab.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import uk.openlab.inputmethod.latin.WordComposer;
import uk.openlab.inputmethod.latin.common.Constants;
import uk.openlab.inputmethod.latin.common.InputPointers;
import uk.openlab.inputmethod.latin.common.StringUtils;
import uk.openlab.inputmethod.latin.define.DebugFlags;
import uk.openlab.inputmethod.latin.settings.SettingsValues;
import uk.openlab.inputmethod.latin.settings.SettingsValuesForSuggestion;
import uk.openlab.inputmethod.latin.settings.SpacingAndPunctuations;
import uk.openlab.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import uk.openlab.inputmethod.latin.utils.AsyncResultHolder;
import uk.openlab.inputmethod.latin.utils.InputTypeUtils;
import uk.openlab.inputmethod.latin.utils.RecapitalizeStatus;
import uk.openlab.inputmethod.latin.utils.StatsUtils;
import uk.openlab.inputmethod.latin.utils.TextRange;
import uk.openlab.inputmethod.logger.LoggerController;
import uk.openlab.inputmethod.logger.data.CursorChange;
...
public final class InputLogic {
     ...
     *     {@link uk.openlab.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link uk.openlab.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link uk.openlab.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, uk.openlab.inputmethod.latin.SuggestedWords)}.
