...
import uk.openlab.inputmethod.compat.InputConnectionCompatUtils;
import uk.openlab.inputmethod.latin.common.Constants;
import uk.openlab.inputmethod.latin.common.UnicodeSurrogate;
import uk.openlab.inputmethod.latin.common.StringUtils;
import uk.openlab.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import uk.openlab.inputmethod.latin.utils.DebugLogUtils;
import uk.openlab.inputmethod.latin.utils.NgramContextUtils;
import uk.openlab.inputmethod.latin.utils.ScriptUtils;
import uk.openlab.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See uk.openlab.inputmethod.latin.common.Constants.UnicodeSurrogate
