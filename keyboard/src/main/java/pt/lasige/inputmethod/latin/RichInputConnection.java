...
import pt.lasige.inputmethod.compat.InputConnectionCompatUtils;
import pt.lasige.inputmethod.latin.common.Constants;
import pt.lasige.inputmethod.latin.common.UnicodeSurrogate;
import pt.lasige.inputmethod.latin.common.StringUtils;
import pt.lasige.inputmethod.latin.inputlogic.PrivateCommandPerformer;
import pt.lasige.inputmethod.latin.settings.SpacingAndPunctuations;
import pt.lasige.inputmethod.latin.utils.CapsModeUtils;
import pt.lasige.inputmethod.latin.utils.DebugLogUtils;
import pt.lasige.inputmethod.latin.utils.NgramContextUtils;
import pt.lasige.inputmethod.latin.utils.ScriptUtils;
import pt.lasige.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See pt.lasige.inputmethod.latin.common.Constants.UnicodeSurrogate
