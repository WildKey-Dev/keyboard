...
package pt.lasige.inputmethod.latin.inputlogic;
...
import pt.lasige.inputmethod.compat.SuggestionSpanUtils;
...
import pt.lasige.inputmethod.latin.Dictionary;
import pt.lasige.inputmethod.latin.DictionaryFacilitator;
import pt.lasige.inputmethod.latin.LastComposedWord;
import pt.lasige.inputmethod.latin.LatinIME;
import pt.lasige.inputmethod.latin.NgramContext;
import pt.lasige.inputmethod.latin.RichInputConnection;
import pt.lasige.inputmethod.latin.Suggest;
...
import pt.lasige.inputmethod.latin.WordComposer;
import pt.lasige.inputmethod.latin.common.Constants;
import pt.lasige.inputmethod.latin.common.InputPointers;
import pt.lasige.inputmethod.latin.common.StringUtils;
import pt.lasige.inputmethod.latin.define.DebugFlags;
import pt.lasige.inputmethod.latin.settings.SettingsValues;
import pt.lasige.inputmethod.latin.settings.SettingsValuesForSuggestion;
import pt.lasige.inputmethod.latin.settings.SpacingAndPunctuations;
import pt.lasige.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import pt.lasige.inputmethod.latin.utils.AsyncResultHolder;
import pt.lasige.inputmethod.latin.utils.InputTypeUtils;
...
public final class InputLogic {
     ...
     *     {@link pt.lasige.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link pt.lasige.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link pt.lasige.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, pt.lasige.inputmethod.latin.SuggestedWords)}.
