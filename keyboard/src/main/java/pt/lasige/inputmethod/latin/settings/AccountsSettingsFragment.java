...
import static pt.lasige.inputmethod.latin.settings.LocalSettingsConstants.PREF_ACCOUNT_NAME;
import static pt.lasige.inputmethod.latin.settings.LocalSettingsConstants.PREF_ENABLE_CLOUD_SYNC;
...
import pt.lasige.inputmethod.latin.accounts.AccountStateChangedListener;
import pt.lasige.inputmethod.latin.accounts.LoginAccountUtils;
import pt.lasige.inputmethod.latin.define.ProductionFlags;
import pt.lasige.inputmethod.latin.permissions.PermissionsUtil;
import pt.lasige.inputmethod.latin.utils.ManagedProfileUtils;
