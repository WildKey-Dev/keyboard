package pt.lasige.cns.study.inputmethod.metrics;
...
import pt.lasige.cns.study.inputmethod.latin.RichInputMethodManager;
...
import pt.lasige.cns.study.inputmethod.metrics.data.ActionCount;
import pt.lasige.cns.study.inputmethod.metrics.data.AutoCorrections;
import pt.lasige.cns.study.inputmethod.metrics.data.CorrectedErrorRate;
import pt.lasige.cns.study.inputmethod.metrics.data.CorrectionActionCount;
import pt.lasige.cns.study.inputmethod.metrics.data.EntryActionCount;
import pt.lasige.cns.study.inputmethod.metrics.data.ErrorCorrectionAttempts;
import pt.lasige.cns.study.inputmethod.metrics.data.FlightTime;
...
import pt.lasige.cns.study.inputmethod.metrics.data.TimePerWord;
import pt.lasige.cns.study.inputmethod.metrics.data.TotalChangedCharacters;
import pt.lasige.cns.study.inputmethod.metrics.data.TotalErrorRate;
import pt.lasige.cns.study.inputmethod.metrics.data.TouchMajorMinor;
import pt.lasige.cns.study.inputmethod.metrics.data.TouchOffsetEntered;
import pt.lasige.cns.study.inputmethod.metrics.data.UncorrectedErrorRate;
import pt.lasige.cns.study.inputmethod.metrics.data.VoiceInput;
import pt.lasige.cns.study.inputmethod.metrics.data.WordsPerMinute;
import pt.lasige.cns.study.inputmethod.metrics.data.WrittenCharacters;
import pt.lasige.cns.study.inputmethod.metrics.data.WrittenNumbers;
import pt.lasige.cns.study.inputmethod.metrics.data.WrittenSpecialChars;
import pt.lasige.cns.study.inputmethod.metrics.util.TextEntryTrialController;
