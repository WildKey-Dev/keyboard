...
import pt.lasige.cns.study.inputmethod.latin.utils.RunInLocale;
...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_LOG_UP_DOWN = "pref_log_keys_up_down";
    public static final String PREF_REFRESH_CONFIG = "pref_refresh_config";
    public static final String PREF_START_PROMPT = "pref_start_prompt";
    public static final String PREF_LOG_IMPLICIT = "pref_log_implicit";
