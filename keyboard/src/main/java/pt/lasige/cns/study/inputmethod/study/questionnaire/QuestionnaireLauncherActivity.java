...
import pt.lasige.cns.study.inputmethod.logger.QuestionnaireObserver;
...
import pt.lasige.cns.study.inputmethod.study.questionnaire.data.QuestionDataHolder;
...
public class QuestionnaireLauncherActivity extends Activity {
    ...
    private void finishQuestionnaire() {
        ...
        save();
        DataBaseFacade.getInstance().setFinished(studyID, questionnaireID, true);
        ScheduleController.getInstance().dequeue(questionnaireID);
                            ...
                            responses.add(
                                    new Tuple("questionnaire_multiple_choice",
                                            new QuestionDataHolder(
                                                    ...
                                                    qr.getStartDate().getTime(),
                                                    qr.getEndDate().getTime(),
