...
package pt.lasige.cns.study.inputmethod.latin.inputlogic;
...
import pt.lasige.cns.study.inputmethod.compat.SuggestionSpanUtils;
...
import pt.lasige.cns.study.inputmethod.latin.Dictionary;
import pt.lasige.cns.study.inputmethod.latin.DictionaryFacilitator;
import pt.lasige.cns.study.inputmethod.latin.LastComposedWord;
import pt.lasige.cns.study.inputmethod.latin.LatinIME;
import pt.lasige.cns.study.inputmethod.latin.NgramContext;
import pt.lasige.cns.study.inputmethod.latin.RichInputConnection;
import pt.lasige.cns.study.inputmethod.latin.Suggest;
import pt.lasige.cns.study.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import pt.lasige.cns.study.inputmethod.latin.SuggestedWords;
import pt.lasige.cns.study.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import pt.lasige.cns.study.inputmethod.latin.WordComposer;
...
import pt.lasige.cns.study.inputmethod.latin.common.StringUtils;
...
import pt.lasige.cns.study.inputmethod.latin.settings.SettingsValuesForSuggestion;
import pt.lasige.cns.study.inputmethod.latin.settings.SpacingAndPunctuations;
import pt.lasige.cns.study.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import pt.lasige.cns.study.inputmethod.latin.utils.AsyncResultHolder;
import pt.lasige.cns.study.inputmethod.latin.utils.InputTypeUtils;
import pt.lasige.cns.study.inputmethod.latin.utils.RecapitalizeStatus;
import pt.lasige.cns.study.inputmethod.latin.utils.StatsUtils;
import pt.lasige.cns.study.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link pt.lasige.cns.study.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link pt.lasige.cns.study.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link pt.lasige.cns.study.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, pt.lasige.cns.study.inputmethod.latin.SuggestedWords)}.
