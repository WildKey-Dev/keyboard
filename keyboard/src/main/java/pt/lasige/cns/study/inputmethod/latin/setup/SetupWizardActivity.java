...
package pt.lasige.cns.study.inputmethod.latin.setup;
...
import pt.lasige.cns.study.inputmethod.compat.TextViewCompatUtils;
import pt.lasige.cns.study.inputmethod.compat.ViewCompatUtils;
import pt.lasige.cns.study.latin.R;
import pt.lasige.cns.study.inputmethod.latin.settings.SettingsActivity;
import pt.lasige.cns.study.inputmethod.latin.settings.SettingsLauncherActivity;
import pt.lasige.cns.study.inputmethod.latin.utils.LeakGuardHandlerWrapper;
import pt.lasige.cns.study.inputmethod.latin.utils.UncachedInputMethodManagerUtils;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                DataBaseFacade.getInstance().getFb().firebaseAuthWithGoogle(getApplicationContext(), account.getIdToken(), densityDpi, height, width, SAVE_EMAIL);
