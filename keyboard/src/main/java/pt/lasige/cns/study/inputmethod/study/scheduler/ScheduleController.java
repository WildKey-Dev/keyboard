package pt.lasige.cns.study.inputmethod.study.scheduler;
...
import pt.lasige.cns.study.inputmethod.latin.settings.SettingsLauncherActivityUI;
import pt.lasige.cns.study.inputmethod.logger.DataBaseFacade;
import pt.lasige.cns.study.inputmethod.logger.data.Config;
import pt.lasige.cns.study.inputmethod.logger.data.Prompt;
import pt.lasige.cns.study.inputmethod.logger.data.TimeFrame;
import pt.lasige.cns.study.inputmethod.study.adapters.PromptLauncherUIController;
...
public class ScheduleController {
    ...
    public Prompt getPrompt(String promptID){
        Prompt p = singlePrompts.get(promptID);
        if(p == null){
            Log.d("PROMPT_WAS_NULL", "getPrompt: id -> " + promptID);
        }
...
//
    ...
    public Prompt getQuestion(String id){
        Prompt p = questions.get(id);
        if(p == null){
            Log.d("PROMPT_WAS_NULL", "getQuestion: id -> " + id);
        }
