package pt.lasige.cns.study.inputmethod.metrics.util;

import pt.lasige.cns.study.inputmethod.metrics.textentry.datastructures.TextEntryTrial;
import pt.lasige.cns.study.inputmethod.metrics.textentry.measures.ComputeEffectiveness;
import pt.lasige.cns.study.inputmethod.metrics.textentry.measures.ComputeISCharacterLevel;
