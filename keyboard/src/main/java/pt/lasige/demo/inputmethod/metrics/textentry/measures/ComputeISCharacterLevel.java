package pt.lasige.demo.inputmethod.metrics.textentry.measures;

import java.util.ArrayList;

import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.AlignedPair;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.ErrorRateResults;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.ISCharacterLevelResults;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.InputAction;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.StreamAlignment;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.TextEntryCondition;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.TextEntryMSD;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.TextEntryParticipantSession;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.TextEntryTrial;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.ISCharacterLevelResults.ErrRateType;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.ISCharacterLevelResults.ErrType;
import pt.lasige.demo.inputmethod.metrics.textentry.datastructures.TextEntryTrial.INPUT_ACTION_TYPE;
