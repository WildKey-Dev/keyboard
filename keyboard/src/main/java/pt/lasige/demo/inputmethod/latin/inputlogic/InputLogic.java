...
package pt.lasige.demo.inputmethod.latin.inputlogic;
...
import pt.lasige.demo.inputmethod.compat.SuggestionSpanUtils;
...
import pt.lasige.demo.inputmethod.latin.Dictionary;
import pt.lasige.demo.inputmethod.latin.DictionaryFacilitator;
import pt.lasige.demo.inputmethod.latin.LastComposedWord;
import pt.lasige.demo.inputmethod.latin.LatinIME;
import pt.lasige.demo.inputmethod.latin.NgramContext;
import pt.lasige.demo.inputmethod.latin.RichInputConnection;
import pt.lasige.demo.inputmethod.latin.Suggest;
import pt.lasige.demo.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import pt.lasige.demo.inputmethod.latin.SuggestedWords;
import pt.lasige.demo.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import pt.lasige.demo.inputmethod.latin.WordComposer;
import pt.lasige.demo.inputmethod.latin.common.Constants;
import pt.lasige.demo.inputmethod.latin.common.InputPointers;
import pt.lasige.demo.inputmethod.latin.common.StringUtils;
import pt.lasige.demo.inputmethod.latin.define.DebugFlags;
import pt.lasige.demo.inputmethod.latin.settings.SettingsValues;
import pt.lasige.demo.inputmethod.latin.settings.SettingsValuesForSuggestion;
import pt.lasige.demo.inputmethod.latin.settings.SpacingAndPunctuations;
import pt.lasige.demo.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import pt.lasige.demo.inputmethod.latin.utils.AsyncResultHolder;
import pt.lasige.demo.inputmethod.latin.utils.InputTypeUtils;
import pt.lasige.demo.inputmethod.latin.utils.RecapitalizeStatus;
import pt.lasige.demo.inputmethod.latin.utils.StatsUtils;
import pt.lasige.demo.inputmethod.latin.utils.TextRange;
import pt.lasige.demo.inputmethod.logger.LoggerController;
import pt.lasige.demo.inputmethod.logger.data.CursorChange;
...
public final class InputLogic {
     ...
     *     {@link pt.lasige.demo.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link pt.lasige.demo.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link pt.lasige.demo.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, pt.lasige.demo.inputmethod.latin.SuggestedWords)}.
