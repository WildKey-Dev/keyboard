package pt.lasige.demo.inputmethod.metrics;
...
import pt.lasige.demo.inputmethod.latin.RichInputMethodManager;
...
import pt.lasige.demo.inputmethod.metrics.data.ActionCount;
import pt.lasige.demo.inputmethod.metrics.data.AutoCorrections;
import pt.lasige.demo.inputmethod.metrics.data.CorrectedErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.CorrectionActionCount;
import pt.lasige.demo.inputmethod.metrics.data.EntryActionCount;
import pt.lasige.demo.inputmethod.metrics.data.ErrorCorrectionAttempts;
import pt.lasige.demo.inputmethod.metrics.data.FlightTime;
import pt.lasige.demo.inputmethod.metrics.data.HoldTimeDeviations;
import pt.lasige.demo.inputmethod.metrics.data.InsertionErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.OmissionErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.SelectedSuggestions;
import pt.lasige.demo.inputmethod.metrics.data.SubstitutionsErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.TimeOutsidePhrase;
import pt.lasige.demo.inputmethod.metrics.data.TimePerWord;
import pt.lasige.demo.inputmethod.metrics.data.TotalChangedCharacters;
import pt.lasige.demo.inputmethod.metrics.data.TotalErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.TouchMajorMinor;
import pt.lasige.demo.inputmethod.metrics.data.TouchOffsetEntered;
import pt.lasige.demo.inputmethod.metrics.data.TouchOffsetError;
import pt.lasige.demo.inputmethod.metrics.data.TouchOffsetTarget;
import pt.lasige.demo.inputmethod.metrics.data.UncorrectedErrorRate;
import pt.lasige.demo.inputmethod.metrics.data.VoiceInput;
import pt.lasige.demo.inputmethod.metrics.data.WordsPerMinute;
import pt.lasige.demo.inputmethod.metrics.data.WrittenCharacters;
import pt.lasige.demo.inputmethod.metrics.data.WrittenNumbers;
import pt.lasige.demo.inputmethod.metrics.data.WrittenSpecialChars;
import pt.lasige.demo.inputmethod.metrics.util.TextEntryTrialController;
