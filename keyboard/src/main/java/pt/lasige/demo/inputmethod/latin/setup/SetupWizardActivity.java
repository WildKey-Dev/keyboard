...
package pt.lasige.demo.inputmethod.latin.setup;
...
import pt.lasige.demo.inputmethod.compat.TextViewCompatUtils;
import pt.lasige.demo.inputmethod.compat.ViewCompatUtils;
import pt.lasige.demo.inputmethod.latin.R;
import pt.lasige.demo.inputmethod.latin.settings.SettingsActivity;
import pt.lasige.demo.inputmethod.latin.settings.SettingsLauncherActivity;
import pt.lasige.demo.inputmethod.latin.utils.LeakGuardHandlerWrapper;
import pt.lasige.demo.inputmethod.latin.utils.UncachedInputMethodManagerUtils;
...
public final class SetupWizardActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        DataBaseFacade.getInstance().setPath(getFilesDir().getAbsolutePath());
    }
    ...
    public void onClick(final View v) {
        if (v == mActionFinish) {
            ...
            intent.setClass(getApplicationContext(), SettingsLauncherActivity.class);
