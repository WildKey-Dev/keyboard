...
import pt.lasige.demo.inputmethod.compat.InputConnectionCompatUtils;
import pt.lasige.demo.inputmethod.latin.common.Constants;
import pt.lasige.demo.inputmethod.latin.common.UnicodeSurrogate;
import pt.lasige.demo.inputmethod.latin.common.StringUtils;
import pt.lasige.demo.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import pt.lasige.demo.inputmethod.latin.utils.DebugLogUtils;
import pt.lasige.demo.inputmethod.latin.utils.NgramContextUtils;
import pt.lasige.demo.inputmethod.latin.utils.ScriptUtils;
import pt.lasige.demo.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See pt.lasige.demo.inputmethod.latin.common.Constants.UnicodeSurrogate
