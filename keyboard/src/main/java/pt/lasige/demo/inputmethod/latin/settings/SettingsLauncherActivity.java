...
import pt.lasige.demo.inputmethod.study.DemoActivity;
...
public class SettingsLauncherActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_start_settings).setOnClickListener(view -> {
        ...
        //gone from the UI
        findViewById(R.id.bt_start_demo_settings).setOnClickListener(view -> {
            final Intent intent = new Intent(getApplicationContext(), DemoActivity.class);
            startActivity(intent);
        });

        findViewById(R.id.bt_start_prompt).setOnClickListener(view -> {
