...
package pt.lasige.ideafast.study.inputmethod.latin.inputlogic;
...
import pt.lasige.ideafast.study.inputmethod.compat.SuggestionSpanUtils;
...
import pt.lasige.ideafast.study.inputmethod.latin.Dictionary;
import pt.lasige.ideafast.study.inputmethod.latin.DictionaryFacilitator;
import pt.lasige.ideafast.study.inputmethod.latin.LastComposedWord;
import pt.lasige.ideafast.study.inputmethod.latin.LatinIME;
import pt.lasige.ideafast.study.inputmethod.latin.NgramContext;
import pt.lasige.ideafast.study.inputmethod.latin.RichInputConnection;
import pt.lasige.ideafast.study.inputmethod.latin.Suggest;
...
import pt.lasige.ideafast.study.inputmethod.latin.WordComposer;
...
import pt.lasige.ideafast.study.inputmethod.latin.common.StringUtils;
...
import pt.lasige.ideafast.study.inputmethod.latin.settings.SettingsValuesForSuggestion;
import pt.lasige.ideafast.study.inputmethod.latin.settings.SpacingAndPunctuations;
import pt.lasige.ideafast.study.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import pt.lasige.ideafast.study.inputmethod.latin.utils.AsyncResultHolder;
import pt.lasige.ideafast.study.inputmethod.latin.utils.InputTypeUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.RecapitalizeStatus;
import pt.lasige.ideafast.study.inputmethod.latin.utils.StatsUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link pt.lasige.ideafast.study.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link pt.lasige.ideafast.study.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link pt.lasige.ideafast.study.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, pt.lasige.ideafast.study.inputmethod.latin.SuggestedWords)}.
    ...
    public boolean wasEditTextEmpty() {
        if(mWordComposer.size() == 0 &&  mConnection.getExpectedSelectionStart() == 1 && mConnection.getTextBeforeCursor(1,0).toString().trim().isEmpty())
            if((mConnection.getExpectedSelectionStart() - 1 - mWordComposer.size()) == 0)
                return true;

        return (mConnection.getExpectedSelectionStart() - mWordComposer.size()) == 0;
    }
