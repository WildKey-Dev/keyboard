...
import pt.lasige.ideafast.study.inputmethod.study.questionnaire.data.Tap;
...
public class DataBaseFacade {
    ...
    public void forceWrite(String key, Object value, String path){
    ...
    public void setImplicitListener(ValueEventListener listener){
        fb.setImplicitListener(listener);
    }

    public void setImplicitScheduleListener(ValueEventListener scheduleListener) {
        fb.setImplicitScheduleListener(scheduleListener);
    }

    public void setImplicitProgrammedScheduleListener(ValueEventListener programmedListener) {
        fb.setImplicitProgrammedScheduleListener(programmedListener);
    }

    public void setExplicitListener(ValueEventListener listener){
        fb.setExplicitListener(listener);
    }
    ...
    public void  saveScheduleToHistory(String start, String end, String activated, String deactivated){
        fb.saveScheduleToHistory(start, end, activated, deactivated);
    }
}
