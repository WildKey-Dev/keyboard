...
import pt.lasige.ideafast.study.inputmethod.accessibility.MoreKeysKeyboardAccessibilityDelegate;
...
public class MoreKeysKeyboardView extends KeyboardView implements MoreKeysPanel {
    ...
    public void onUpEvent(final int x, final int y, final int pointerId, final long eventTime) {
        ...
        if (mCurrentKey != null) {
            ...
            if(mCurrentKey != null){
                LoggerController.getInstance().getLogger().writeToBuffer(mCurrentKey, x, y, eventTime);
            }
            mCurrentKey = null;
        }
    }
    ...
    public boolean onTouchEvent(final MotionEvent me) {
        ...
        LoggerController.getInstance().getLogger().logMotionEvent(me);
