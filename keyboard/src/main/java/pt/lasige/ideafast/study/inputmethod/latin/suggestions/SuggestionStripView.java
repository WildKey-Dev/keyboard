...
package pt.lasige.ideafast.study.inputmethod.latin.suggestions;
...
import pt.lasige.ideafast.study.inputmethod.keyboard.KeyboardTheme;
import pt.lasige.ideafast.study.inputmethod.keyboard.MainKeyboardView;
import pt.lasige.ideafast.study.inputmethod.keyboard.MoreKeysPanel;
import pt.lasige.ideafast.study.inputmethod.latin.AudioAndHapticFeedbackManager;
...
import pt.lasige.ideafast.study.inputmethod.latin.suggestions.MoreSuggestionsView.MoreSuggestionsListener;
...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    public SuggestionStripView(final Context context, final AttributeSet attrs,
        ...
        if(data.isEmpty() || !Explicit.getInstance().isOn()) {
...
//        mVoiceKey.setVisibility(currentSettingsValues.mShowsVoiceInputKey ? VISIBLE : INVISIBLE);
    ...
    public void updateLogButtonVisibility() {
        if(MetricsController.getInstance().mode == StudyConstants.IMPLICIT_MODE){
            if(!LoggerController.getInstance().isPrivateMode())
    ...
    public void onClick(final View view) {
        ...
        if(view == mKillSwitch){
            if(LoggerController.getInstance().isPrivateMode()) {
                ...
                LoggerController.getInstance().setPrivateMode(!LoggerController.getInstance().isPrivateMode());
