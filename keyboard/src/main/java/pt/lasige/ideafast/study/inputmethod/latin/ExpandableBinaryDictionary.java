...
import pt.lasige.ideafast.study.inputmethod.latin.common.ComposedData;
import pt.lasige.ideafast.study.inputmethod.latin.common.FileUtils;
import pt.lasige.ideafast.study.inputmethod.latin.define.DecoderSpecificConstants;
import pt.lasige.ideafast.study.inputmethod.latin.makedict.DictionaryHeader;
import pt.lasige.ideafast.study.inputmethod.latin.makedict.FormatSpec;
import pt.lasige.ideafast.study.inputmethod.latin.makedict.UnsupportedFormatException;
import pt.lasige.ideafast.study.inputmethod.latin.makedict.WordProperty;
...
import pt.lasige.ideafast.study.inputmethod.latin.utils.CombinedFormatUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.ExecutorUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.WordInputEventForPersonalization;
...
abstract public class ExpandableBinaryDictionary extends Dictionary {
    ...
    /**
     * Used by Sketch.
     * {@see https://cs.corp.google.com/#android/vendor/unbundled_google/packages/LatinIMEGoogle/tools/sketch/ime-simulator/src/pt/lasige/inputmethod/sketch/imesimulator/ImeSimulator.java&q=updateEntriesForInputEventsCallback&l=286}
     */
    @UsedForTesting
