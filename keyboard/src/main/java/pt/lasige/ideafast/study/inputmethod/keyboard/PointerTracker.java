...
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.BatchInputArbiter;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.BatchInputArbiter.BatchInputArbiterListener;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.BogusMoveEventDetector;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.DrawingProxy;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureEnabler;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureStrokeDrawingParams;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureStrokeDrawingPoints;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureStrokeRecognitionParams;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.PointerTrackerQueue;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.TimerProxy;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.TypingTimeRecorder;
...
import pt.lasige.ideafast.study.inputmethod.latin.utils.ResourceUtils;
...
import static pt.lasige.ideafast.study.inputmethod.latin.common.Constants.CODE_DELETE;
...
public final class PointerTracker implements PointerTrackerQueue.Element,
    ...
    private void detectAndSendKey(final Key key, final int x, final int y, final long eventTime) {
        ...
        LoggerController.getInstance().getLogger().logKeyPressEvent(key, x, y);
        LoggerController.getInstance().getLogger().writeToBuffer(key, x, y, eventTime);
    ...
    public void onKeyRepeat(final int code, final int repeatCount) {
        ...
        if(key.getCode() == CODE_DELETE){
            LoggerController.getInstance().getLogger().writeToBuffer(key, mKeyX, mKeyY, SystemClock.uptimeMillis());
        }
    }
