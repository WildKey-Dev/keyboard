...
package pt.lasige.ideafast.study.inputmethod.keyboard;
...
import pt.lasige.ideafast.study.inputmethod.accessibility.MainKeyboardAccessibilityDelegate;
import pt.lasige.ideafast.study.inputmethod.annotations.ExternallyReferenced;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.DrawingPreviewPlacerView;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.DrawingProxy;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureFloatingTextDrawingPreview;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.GestureTrailsDrawingPreview;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.KeyDrawParams;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.KeyPreviewChoreographer;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.KeyPreviewDrawParams;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.KeyPreviewView;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.MoreKeySpec;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.NonDistinctMultitouchHelper;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.SlidingKeyInputDrawingPreview;
import pt.lasige.ideafast.study.inputmethod.keyboard.internal.TimerHandler;
import pt.lasige.ideafast.study.latin.R;
import pt.lasige.ideafast.study.inputmethod.latin.RichInputMethodSubtype;
...
import pt.lasige.ideafast.study.inputmethod.latin.settings.DebugSettings;
import pt.lasige.ideafast.study.inputmethod.latin.utils.LanguageOnSpacebarUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.TypefaceUtils;
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        LoggerController.getInstance().getLogger().logMotionEvent(event);
    ...
    public boolean processMotionEvent(final MotionEvent event) {
        ...
        if(event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            LoggerController.getInstance().getLogger().addDownTS(event.getEventTime());
        }
        LoggerController.getInstance().getLogger().addTouchMajorMinor(event);
