...
import pt.lasige.ideafast.study.inputmethod.study.adapters.MultiChoiceAdapter;

public class MultiChoiceCustom implements Step {
    ...
    public MultiChoiceCustom(String question, String continueText, ArrayList<String> steps, boolean optional, StepIdentifier id) {
    ...
    public StepView createView(@NotNull Context context, @Nullable StepResult stepResult) {
        return new StepView(context, id, optional) {
            ...
            public QuestionResult createResults() {
                ...
                return new MultiChoiceCustomResult(checked, id, start, end);
            }
    ...
    static class MultiChoiceCustomResult implements QuestionResult, Parcelable {

        ArrayList<String> answer;
        Identifier id;
        Date start, end;

        public MultiChoiceCustomResult(ArrayList<String> answer, Identifier id, Date start, Date end) {
            this.answer = answer;
            this.id = id;
            this.start = start;
            this.end = end;
        ...
        protected MultiChoiceCustomResult(Parcel in) { }

        public final Creator<MultiChoiceCustomResult> CREATOR = new Creator<MultiChoiceCustomResult>() {
            @Override
            public MultiChoiceCustomResult createFromParcel(Parcel in) {
                return new MultiChoiceCustomResult(in);
            }

            @Override
            public MultiChoiceCustomResult[] newArray(int size) {
                return new MultiChoiceCustomResult[size];
            }
        };
