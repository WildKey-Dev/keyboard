...
import static pt.lasige.ideafast.study.inputmethod.latin.common.Constants.ImeOption.NO_FLOATING_GESTURE_PREVIEW;
...
public final class InputAttributes {
     ...
     * {@link pt.lasige.ideafast.study.inputmethod.latin.settings.SettingsValues#mGestureFloatingPreviewTextEnabled}
     */
    ...
    public InputAttributes(final EditorInfo editorInfo, final boolean isFullscreenMode,
        ...
        boolean flagNoSuggestions =
                0 != (inputType & InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
        boolean flagMultiLine =
                0 != (inputType & InputType.TYPE_TEXT_FLAG_MULTI_LINE);
        boolean flagAutoCorrect =
                0 != (inputType & InputType.TYPE_TEXT_FLAG_AUTO_CORRECT);
        boolean flagAutoComplete =
                0 != (inputType & InputType.TYPE_TEXT_FLAG_AUTO_COMPLETE);

        flagNoSuggestions = false;
        flagAutoComplete = true;
        flagAutoCorrect = true;
