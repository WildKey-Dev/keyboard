...
import pt.lasige.ideafast.study.inputmethod.compat.InputConnectionCompatUtils;
import pt.lasige.ideafast.study.inputmethod.latin.common.Constants;
import pt.lasige.ideafast.study.inputmethod.latin.common.UnicodeSurrogate;
import pt.lasige.ideafast.study.inputmethod.latin.common.StringUtils;
import pt.lasige.ideafast.study.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import pt.lasige.ideafast.study.inputmethod.latin.utils.DebugLogUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.NgramContextUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.ScriptUtils;
import pt.lasige.ideafast.study.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See pt.lasige.ideafast.study.inputmethod.latin.common.Constants.UnicodeSurrogate
