...
//        }
    ...
    private void sendRegistrationToServer(String token) {
        if(!DataBaseFacade.getInstance().setFCMToken(token))
            Toast.makeText(getApplicationContext(), "Utilizador não tem login", Toast.LENGTH_SHORT).show();
    }
    ...
    private void sendNotification(String messageBody, String title) {
        ...
        PendingIntent pi = PendingIntent.getActivity(getApplicationContext(), 0,pra, PendingIntent.FLAG_UPDATE_CURRENT);
